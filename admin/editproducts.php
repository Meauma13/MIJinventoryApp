...
if (strlen($_SESSION['imsaid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "update tblproducts set ProductName='$pname',CategoryID='$category',Stock='$stock',CostPrice='$costprice',SellingPrice='$sellingprice',Barcode='$barcode',Status='$status' where ID='$eid'");
    if ($query) {
            ...
            <div class="widget-box">
              ...
              <div class="widget-content nopadding">
                <form method="post" class="form-horizontal">
                  <?php
                  $eid = $_GET['editid'];
                  $ret = mysqli_query($con, "select tblcategory.CategoryName as catname,tblcategory.ID as catid,tblproducts.ID as pid,tblproducts.ProductName,tblproducts.Status,tblproducts.CostPrice,tblproducts.SellingPrice,tblproducts.Stock, tblproducts.Barcode from tblproducts inner join tblcategory on tblcategory.ID=tblproducts.CategoryID where tblproducts.ID='$eid'");
                ...
                <select type="text" class="span11" name="subcategory" id="subcategory" value="" required='true' />
                  <option value="<?php // echo $row['scatid'];
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input type="text" class="span11" name="barcode" id="barcode" value="<?php echo $row['Barcode']; ?>" placeholder="Enter Barcode (optional)" />
                      </div>
                    </div>
                    <div class="control-group">
