<!--Header-part-->
<div id="header">
  <h2 style="padding-top: 20px; padding-left: 10px; font-size: 38px"><a href="dashboard.php"><strong style="color: grey">IMS Admin</strong></a></h2>
</div>
<!--close-Header-part-->
<!--top-Header-menu-->
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
 <?php
$ret=mysqli_query($con,"select AdminName from tbladmin where ID='".$_SESSION['imsaid']."'");
